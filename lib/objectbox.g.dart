...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 6811350421697420067),
      name: 'TextChunk',
      lastPropertyId: const obx_int.IdUid(4, 2181026966474333055),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 5524476010308919366),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3576333525798289135),
            name: 'text',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 1398032837567025313),
            name: 'metadata',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
...
obx_int.ModelDefinition getObjectBoxModel() {
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    TextChunk: obx_int.EntityDefinition<TextChunk>(
        model: _entities[0],
        toOneRelations: (TextChunk object) => [],
        ...
        objectToFB: (TextChunk object, fb.Builder fbb) {
          ...
          final vectorOffset = object.vector == null
              ? null
              : fbb.writeListFloat64(object.vector!);
          fbb.startTable(5);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = TextChunk(
              text: textParam, metadata: metadataParam, vector: vectorParam)
...
class TextChunk_ {
  /// see [TextChunk.id]
  static final id =
      obx.QueryIntegerProperty<TextChunk>(_entities[0].properties[0]);

  /// see [TextChunk.text]
  static final text =
      obx.QueryStringProperty<TextChunk>(_entities[0].properties[1]);

  /// see [TextChunk.metadata]
  static final metadata =
      obx.QueryStringProperty<TextChunk>(_entities[0].properties[2]);
